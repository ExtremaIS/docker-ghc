...
ghc-9.2: GHC_URL = https://downloads.haskell.org/~ghc/9.2.6/ghc-9.2.6-x86_64-deb10-linux.tar.xz
ghc-9.2: GHC_DIR = ghc-9.2.6
...
ghc-9.4: GHC_URL = https://downloads.haskell.org/ghc/9.4.4/ghc-9.4.4-x86_64-deb11-linux.tar.xz
ghc-9.4: GHC_DIR = ghc-9.4.4-x86_64-unknown-linux
...
ghc-9.6: GHC_URL = https://downloads.haskell.org/ghc/9.6.1-alpha3/ghc-9.6.0.20230210-x86_64-deb11-linux.tar.xz
ghc-9.6: GHC_DIR = ghc-9.6.0.20230210-x86_64-unknown-linux
ghc-9.6: CABAL_URL = https://downloads.haskell.org/~cabal/cabal-install-3.8.1.0/cabal-install-3.8.1.0-x86_64-linux-deb10.tar.xz
