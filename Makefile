...
ghc-9.6: GHC_URL = https://downloads.haskell.org/~ghc/9.6.4/ghc-9.6.4-x86_64-deb11-linux.tar.xz
ghc-9.6: GHC_DIR = ghc-9.6.4-x86_64-unknown-linux
ghc-9.6: CABAL_URL = https://downloads.haskell.org/~cabal/cabal-install-3.10.2.0/cabal-install-3.10.2.0-x86_64-linux-deb11.tar.xz
...
ghc-9.8: GHC_URL = https://downloads.haskell.org/~ghc/9.8.2/ghc-9.8.2-x86_64-deb12-linux.tar.xz
ghc-9.8: GHC_DIR = ghc-9.8.2-x86_64-unknown-linux
...
ghc-9.10: GHC_URL = https://downloads.haskell.org/ghc/9.10.1-alpha3/ghc-9.10.0.20240413-x86_64-deb12-linux.tar.xz
ghc-9.10: GHC_DIR = ghc-9.10.0.20240413-x86_64-unknown-linux
