...
ghc-9.6: GHC_URL = https://downloads.haskell.org/ghc/9.6.7/ghc-9.6.7-x86_64-deb11-linux.tar.xz
ghc-9.6: GHC_DIR = ghc-9.6.7-x86_64-unknown-linux
ghc-9.6: CABAL_URL = https://downloads.haskell.org/~cabal/cabal-install-3.14.1.1/cabal-install-3.14.1.1-x86_64-linux-deb12.tar.xz
...
ghc-9.8: GHC_URL = https://downloads.haskell.org/~ghc/9.8.4/ghc-9.8.4-x86_64-deb12-linux.tar.xz
ghc-9.8: GHC_DIR = ghc-9.8.4-x86_64-unknown-linux
...
ghc-9.10: GHC_URL = https://downloads.haskell.org/ghc/9.10.3/ghc-9.10.3-x86_64-deb12-linux.tar.xz
ghc-9.10: GHC_DIR = ghc-9.10.3-x86_64-unknown-linux
ghc-9.10: CABAL_URL = https://downloads.haskell.org/~cabal/cabal-install-3.16.0.0/cabal-install-3.16.0.0-x86_64-linux-deb12.tar.xz
...
ghc-9.12: GHC_URL = https://downloads.haskell.org/~ghc/9.12.5-rc3/ghc-9.12.4.20260713-x86_64-deb12-linux.tar.xz
ghc-9.12: GHC_DIR = ghc-9.12.4.20260713-x86_64-unknown-linux
ghc-9.12: CABAL_URL = https://downloads.haskell.org/~cabal/cabal-install-3.18.1.0/cabal-install-3.18.1.0-x86_64-linux-unknown.tar.xz
...
ghc-9.14: GHC_URL = https://downloads.haskell.org/ghc/9.14.2-rc2/ghc-9.14.1.20260916-x86_64-deb12-linux.tar.xz
ghc-9.14: GHC_DIR = ghc-9.14.1.20260916-x86_64-unknown-linux
ghc-9.14: CABAL_URL = https://downloads.haskell.org/~cabal/cabal-install-3.18.1.0/cabal-install-3.18.1.0-x86_64-linux-unknown.tar.xz
ghc-9.14: DISTRO = bookworm
ghc-9.14: build-manual
.PHONY: ghc-9.14

ghc-10.0: # build GHC 10.0 image
ghc-10.0: DOCKER_TAG = 10.0
ghc-10.0: GHC_URL = https://downloads.haskell.org/ghc/10.0.1-alpha1/ghc-10.0.0.20260917-x86_64-deb13-linux.tar.xz
ghc-10.0: GHC_DIR = ghc-10.0.0.20260917-x86_64-unknown-linux
ghc-10.0: CABAL_URL = https://downloads.haskell.org/~cabal/cabal-install-3.18.1.0/cabal-install-3.18.1.0-x86_64-linux-unknown.tar.xz
ghc-10.0: DISTRO = trixie
ghc-10.0: build-manual
.PHONY: ghc-10.0
