...
ghc-9.4: GHC_URL = https://downloads.haskell.org/~ghc/9.4.5/ghc-9.4.5-x86_64-deb11-linux.tar.xz
ghc-9.4: GHC_DIR = ghc-9.4.5-x86_64-unknown-linux
ghc-9.4: CABAL_URL = https://downloads.haskell.org/~cabal/cabal-install-3.8.1.0/cabal-install-3.8.1.0-x86_64-linux-deb10.tar.xz
