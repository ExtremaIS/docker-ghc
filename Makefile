...
ghc-9.10: GHC_URL = https://downloads.haskell.org/ghc/9.10.2/ghc-9.10.2-x86_64-deb12-linux.tar.xz
ghc-9.10: GHC_DIR = ghc-9.10.2-x86_64-unknown-linux
ghc-9.10: CABAL_URL = https://downloads.haskell.org/~cabal/cabal-install-3.14.2.0/cabal-install-3.14.2.0-x86_64-linux-deb12.tar.xz
