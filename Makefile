...
ghc-9.12: GHC_URL = http://downloads.haskell.org/~ghc/9.12.1-rc1/ghc-9.12.0.20241128-x86_64-deb12-linux.tar.xz
ghc-9.12: GHC_DIR = ghc-9.12.0.20241128-x86_64-unknown-linux
