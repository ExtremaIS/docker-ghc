...
ghc-9.6: GHC_URL = https://downloads.haskell.org/ghc/9.6.1-rc1/ghc-9.6.0.20230302-x86_64-deb11-linux.tar.xz
ghc-9.6: GHC_DIR = ghc-9.6.0.20230302-x86_64-unknown-linux
