...
ghc-9.2: GHC_URL = https://downloads.haskell.org/ghc/9.2.4/ghc-9.2.4-x86_64-deb10-linux.tar.xz
ghc-9.2: GHC_DIR = ghc-9.2.4
...
ghc-9.4: GHC_URL = https://downloads.haskell.org/ghc/9.4.3/ghc-9.4.3-x86_64-deb11-linux.tar.xz
ghc-9.4: GHC_DIR = ghc-9.4.3-x86_64-unknown-linux
