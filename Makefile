...
ghc-9.12: GHC_URL = https://downloads.haskell.org/ghc/9.12.1-alpha3/ghc-9.12.0.20241114-x86_64-deb12-linux.tar.xz
ghc-9.12: GHC_DIR = ghc-9.12.0.20241114-x86_64-unknown-linux
