...
ghc-9.10: GHC_URL = https://downloads.haskell.org/ghc/9.10.1-alpha2/ghc-9.10.0.20240328-x86_64-deb12-linux.tar.xz
ghc-9.10: GHC_DIR = ghc-9.10.0.20240328-x86_64-unknown-linux
