...
ghc-9.8: GHC_URL = https://downloads.haskell.org/ghc/9.8.1-alpha2/ghc-9.8.0.20230809-x86_64-deb11-linux.tar.xz
ghc-9.8: GHC_DIR = ghc-9.8.0.20230809-x86_64-unknown-linux
